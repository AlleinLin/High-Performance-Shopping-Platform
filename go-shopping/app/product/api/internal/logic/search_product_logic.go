...
func (l *SearchProductLogic) SearchProduct(req *types.SearchProductRequest) (resp *types.Response, err error) {
	products, total, err := l.svcCtx.ProductModel.Search(req.Keyword, req.Page, req.PageSize)
	if err != nil {
		return nil, err
	}
