...
func (l *GetProductListLogic) GetProductList(req *types.GetProductListRequest) (resp *types.Response, err error) {
	products, total, err := l.svcCtx.ProductModel.Search("", req.Page, req.PageSize)
	if err != nil {
		return nil, err
	}
